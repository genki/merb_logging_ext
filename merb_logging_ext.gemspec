...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README", "Rakefile", "TODO", "lib/merb_logging_ext", "lib/merb_logging_ext/colorful.rb", "lib/merb_logging_ext/logging_ext.rb", "lib/merb_logging_ext/merbtasks.rb", "lib/merb_logging_ext.rb", "spec/merb_logging_ext_spec.rb", "spec/spec_helper.rb"]
  s.has_rdoc = true
